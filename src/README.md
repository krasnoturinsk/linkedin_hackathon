...
<details><summary>**Что необходимо сделать?**</summary>
...
<details><summary>**Какая проблема существует?**</summary>
...
<details><summary>**Результат продукта**</summary>
...
<details><summary>**Функциональные требования**</summary>
...
<details><summary>**Как созданное решение использовать как постоянный сервис**</summary>
